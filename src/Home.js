...
import library from './assets/library3.PNG'
                            ...
                            <h3 className='card'>
                                ...
                                <div className='mainSide'>
                                    ...
                                    <div className='nameSide'>
                                        ...
                                        {issuedBooks.includes(book.id) ? <button className="issuedBtn">Issued</button> :
                                            <button onClick={() => { cardTOForm(book.name, book.dollar, book.id, book.src) }} className="issuBtn">Issue</button>
                                        }
                                    </div>
                                </div>
